...
export const academicEducationFields = [
  {
    name: "name",
    type: "text",
  ...
  },
  {
    ...
    disabled: (fieldWatchedValue) => fieldWatchedValue,
    required: (fieldWatchedValue) => !fieldWatchedValue,
  },
  {
    name: "endDateYear",
    type: "select",
    options: yearListWithMore,
